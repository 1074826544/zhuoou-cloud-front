...
export {default as PopupIcon} from './icons/PopupIcon.vue';

export {default as IconSelect} from './form/IconSelect.vue';
...
export {default as ItemOp} from './itemop/ItemOp.vue';
...
export {default as CountTo} from './count/count-to/count-to.vue';

export {default as ChartPie} from './charts/pie.vue';

export {default as ChartBar} from './charts/bar.vue';

export {default as InforCard} from './info-card/info-card.vue';
