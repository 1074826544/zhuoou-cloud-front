...
<template>
  <Row class="curd-view main-view" :class="{'main-view-full': full}">
    <!--左边树-->
    <i-col v-if="treeOptions" :xs="9" :sm="5" :md="5" :lg="4" class="curd-view-left-col"
    ...
    <!--左边树结束-->
    <!--右边信息栏-->
    <i-col :xs="rightSpan(15)" :sm="rightSpan(19)" :md="rightSpan(19)" :lg="rightSpan(20)" :xs-offset="8" :sm-offset="8"
