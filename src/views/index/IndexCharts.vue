  ...
  <Row :gutter='20'>
    <i-col span='6'>
      <Card :bordered='false' style='height: 155px'>
        ...
        <div id='chart1' style='height: 110px;width: 90%;'></div>
      </Card>
    </i-col>
    <i-col span='6'>
      <Card :bordered='false' style='height: 155px'>
        ...
        <div id='chart2' style='height: 110px;width: 90%;'></div>
      </Card>
    </i-col>
    <i-col span='6'>
      <Card :bordered='false' style='height: 155px'>
        ...
        <div id='chart3' style='height: 110px;width: 90%;'></div>
      </Card>
    </i-col>
    <i-col span='6'>
      <Card :bordered='false' style='height: 155px'>
        ...
        <div id='chart4' style='height: 110px;width: 90%;'></div>
      </Card>
    </i-col>
